...
export const CkEditorCustom = (_a) => {
    ...
    const { CKEditor, EditorCustom } = editorRef.current || {};
    React.useEffect(() => {
        editorRef.current = {
            CKEditor: require("@ckeditor/ckeditor5-react"),
            EditorCustom: require("@min98/ckeditor5-custom"),
        };
    ...
    return editorLoaded ? (_jsx(CKEditor, Object.assign({ config: Configuration, editor: EditorCustom, onReady: (editor) => {
            var _a;
        ...
        } }, props))) : (_jsx("div", { children: "Editor loading" }));
};
