...
const FormLabel = React.forwardRef((_a, ref) => {
    ...
    return (_jsx(Label, Object.assign({ ref: ref, className: cn(error && "text-danger", className), htmlFor: formItemId }, props)));
});
...
const FormDescription = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("p", Object.assign({ ref: ref, id: formDescriptionId, className: cn("text-[0.8rem] text-gray-500", className) }, props)));
});
...
const FormMessage = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("p", Object.assign({ ref: ref, id: formMessageId, className: cn("text-[0.8rem] font-medium text-danger", className) }, props, { children: body })));
});
